from inference import norm_01, ensemble_softmax_list
...
def infer_on_images(model_dir, image_dir, output_dir):
    ...
    trainer, params = load_model_and_checkpoint_files(
        folder=os.path.join(model_dir, 'he', 'nnUNetTrainerV2_BN_pathology_DA_ignore0_hed005__nnUNet_RGB_scaleTo_0_1_bs8_ps512'),
        folds=folds,
...
def main():
    ...
    parser.add_argument("--output_dir", "o", help="Directory where predictions are saved", default=None)
